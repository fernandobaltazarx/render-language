...
var ChangeNameForm = React.createClass({
  ...
  getInitialState: function getIntialState() {
    return { newName: '' };
  },
...
var ChatApp = React.createClass({
  ...
  componentDidMount: function componentDidMount() {
    socket.on('init', this._initalize);
  ...
  _initalize: function _initalize(data) {
  ...
  _usersChangedName: function _userChangedName(data) {
...
React.render(React.createElement(ChatApp, null), document.getElementById('app'));
  ...
  process.env = {};
  process.argv = [];
  process.version = '';//empty string to avoid regex issues
  process.versions = {};
...
assign(CallbackQueue.prototype, {
 ...
 notifyAll: function() {
   ...
   if (callbacks) {
     ("production" !== environment ? invariant(
...
var DOMPropertyOperations = {
 ...
 dangerouslyRenderMarkup: function(markupList) {
  ...
  dangerouslyReplaceNodeWithMarkup: function(oldChild, markup) {
    ...
    ("production" !== environment ? invariant(markup, 'dangerouslyReplaceNodeWithMarkup(...): Missing markup.') : invariant(markup));
    ("production" !== environment ? invariant(
...
var LocalEventTrapMixin = {
  trapBubbledEvent:function(topLevelType, handlerBaseName) {
    ("production" !== environment ? invariant(this.isMounted(), 'Must be mounted to trap events') : invariant(this.isMounted()));
...
var environment = 'production';
 ...
 function validateDangerousTag(tag) {
   if (!hasOwnProperty.call(validatedTagCache, tag)) {
     ("production" !== environment ? invariant(VALID_TAG_REGEX.test(tag), 'Invalid tag: %s', tag) : invariant(VALID_TAG_REGEX.test(tag)));
       ...
       for (var propName in propTypes) {
         if (propTypes.hasOwnProperty(propName)) {
           ...
           if (error instanceof Error && !(error.message in loggedTypeFailures)) {
             ...
             var addendum = getDeclarationErrorAddendum(this);
             ("production" !== environment ? warning(false, 'Failed propType: %s%s', error.message, addendum) : null);
           }
         }
       }
     }
 ...
 var ReactReconciler = {
   ...
   receiveComponent: function(
      ...
      */
      ...
      },{"./CallbackQueue":7,"./Object.assign":28,"./PooledClass":29,"./ReactPutListenerQueue":81,"./Transaction":105,"./emptyFunction":116}],137:[function(require,module,exports){
      (function (process){
      /**
       * Copyright 2015, Facebook, Inc.
       * All rights reserved.
      ...
      },{"./Object.assign":28,"./ReactCurrentOwner":41,"./ReactElement":59,"./ReactInstanceMap":69,"./ReactLifeCycle":70,"./ReactUpdates":89,"invariant":137,"./warning":156,"_process":2}],189:[function(require,module,exports){
      (function (process){
      /**
       * Copyright 2013-2015, Facebook, Inc.
       * All rights reserved.
      ...
      var Mixin = {
        ...
        /**
         * `PooledClass` looks for this, and will invokeTHIS this before allowing this
         * instance to be resused.
         */
        destructor: function() {
          CallbackQueue.release(this.reactMountReady);
...
function createNodesFromMarkup(markup, handleScript) {
  var node = dummyNode;
  ("production" !== environment ? invariant(!!dummyNode, 'createNodesFromMarkup dummy not initialized') : invariant(!!dummyNode));
...
// }).call(this,require('_process'))
},{"./traverseAllChildren":155,"./warning":156,"_process":2}],1121:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
function getMarkupWrap(nodeName) {
  ("production" !== environment ? invariant(!!dummyNode, 'Markup wrapping node not initialized') : invariant(!!dummyNode));
